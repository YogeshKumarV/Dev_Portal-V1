...
@Component({
  selector: 'app-view-api-products',
  templateUrl: './view-api-products.component.html',
  styleUrl: './view-api-products.component.css'
})
export class ViewApiProductsComponent {
